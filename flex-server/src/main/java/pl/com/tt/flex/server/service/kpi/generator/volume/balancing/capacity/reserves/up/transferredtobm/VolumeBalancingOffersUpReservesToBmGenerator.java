...
/**
 * KPI - Wolumen usług bilansujących na rezerwy w górę przekazane do RB/Volume of balancing service offers for UP reserves transferred to BM
 */
@Component
@AllArgsConstructor
public class VolumeBalancingOffersUpReservesToBmGenerator extends KpiGenerator {
    ...
    protected void fillSheet(XSSFWorkbook workbook, KpiDTO kpiDTO) {
        VolumeBalancingOffersReservesData volumeBalancingOffersReservesData = volumeBalancingOffersUpReservesToBmDataFactory
    ...
    protected String getTemplate() {
        return "templates/xlsx/kpi/volume/balancing/capacity/reserves/up/VolumeBalancingOffersUpReservesTransferredToBM.xlsx";
    }
    ...
    protected String getFilename(KpiDTO kpiDTO) {
        ...
        return String.format("Volume_of_balancing_service_offers_for_UP_reserves_transferred_to_BM_%s-%s.xlsx", from, to);
    }

    @Override
    public boolean isSupported(KpiType kpiType) {
        return kpiType.equals(KpiType.VOLUME_OF_BALANCING_SERVICE_OFFERS_UP_RESERVES_TRANSFERRED_TO_BM);
    }
}
