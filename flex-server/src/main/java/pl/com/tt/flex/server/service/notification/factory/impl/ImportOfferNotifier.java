...
@Component
@Slf4j
public class ImportOfferNotifier extends AbstractNotifier {

    private static final List<NotificationEvent> SUPPORTED_EVENTS = Collections.singletonList(BID_IMPORT);

    public ImportOfferNotifier(SocketEventEmitter socketEventEmitter, NotificationService notificationService, UserService userService) {
