...
public interface FlexAdminRefreshViewWebsocketResource {
    ...
    @PostMapping(value = "/api/broadcast/refresh-view/auctions/algorithm-evaluations", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ResponseEntity<Void> postModifiedAlgorithmEvaluation(@RequestBody AlgorithmEvaluationViewDTO algorithmEvaluationViewDTO);
