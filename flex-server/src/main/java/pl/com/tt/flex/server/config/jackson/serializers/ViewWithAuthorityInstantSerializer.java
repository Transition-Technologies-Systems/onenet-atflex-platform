...
public class ViewWithAuthorityInstantSerializer extends InstantSerializer {
    ...
    public ViewWithAuthorityInstantSerializer(Set<String> packages) {
        super();
     ...
     */
    @Override
    public void serialize(Instant value, JsonGenerator g, SerializerProvider provider) throws IOException {
