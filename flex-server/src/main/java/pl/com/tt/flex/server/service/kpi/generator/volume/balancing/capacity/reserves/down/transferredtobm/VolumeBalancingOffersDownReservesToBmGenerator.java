...
/**
 * KPI - Wolumen usług bilansujących na rezerwy w dół przekazane do RB/Volume of balancing service offers for DOWN reserves transferred to BM
 */
@Component
@AllArgsConstructor
public class VolumeBalancingOffersDownReservesToBmGenerator extends KpiGenerator {
    ...
    protected void fillSheet(XSSFWorkbook workbook, KpiDTO kpiDTO) {
        VolumeBalancingOffersReservesData volumeBalancingOffersReservesData = volumeBalancingOffersDownReservesToBmDataFactory
    ...
    protected String getTemplate() {
        return "templates/xlsx/kpi/volume/balancing/capacity/reserves/down/VolumeBalancingOffersDownReservesTransferredToBM.xlsx";
    }
    ...
    protected String getFilename(KpiDTO kpiDTO) {
        ...
        return String.format("Volume_of_balancing_service_offers_for_DOWN_reserves_transferred_to_BM_%s-%s.xlsx", from, to);
    }

    @Override
    public boolean isSupported(KpiType kpiType) {
        return kpiType.equals(KpiType.VOLUME_OF_BALANCING_SERVICE_OFFERS_DOWN_RESERVES_TRANSFERRED_TO_BM);
    }
}
