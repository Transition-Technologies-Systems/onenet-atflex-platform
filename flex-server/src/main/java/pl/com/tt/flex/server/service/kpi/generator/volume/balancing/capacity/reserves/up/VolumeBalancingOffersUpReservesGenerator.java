...
/**
 * KPI - Wolumen usług bilansujących na rezerwy w górę/Volume of balancing service offers for UP reserves
 */
@Component
@AllArgsConstructor
public class VolumeBalancingOffersUpReservesGenerator extends KpiGenerator {
    ...
    protected void fillSheet(XSSFWorkbook workbook, KpiDTO kpiDTO) {
        VolumeBalancingOffersReservesData volumeBalancingOffersReservesData = volumeBalancingOffersUpReservesDataFactory
    ...
    protected String getTemplate() {
        return "templates/xlsx/kpi/volume/balancing/capacity/reserves/up/VolumeBalancingOffersUpReserves.xlsx";
    }
    ...
    protected String getFilename(KpiDTO kpiDTO) {
        ...
        return String.format("Volume_of_balancing_service_offers_for_UP_reserves_%s-%s.xlsx", from, to);
    }

    @Override
    public boolean isSupported(KpiType kpiType) {
        return kpiType.equals(KpiType.VOLUME_OF_BALANCING_SERVICE_OFFERS_UP_RESERVES);
    }
}
