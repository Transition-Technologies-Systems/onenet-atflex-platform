...
public class PowerExchangeDeviationDataFactory extends ExchangeDeviationDataFactory {

    public PowerExchangeDeviationDataFactory(AuctionDayAheadOfferRepository auctionDayAheadOfferRepository, AuctionCmvcOfferRepository auctionCmvcOfferRepository, SettlementViewRepository settlementRepository) {
    ...
    public ExchangeDeviationData create(Instant acceptedDeliveryFrom, Instant acceptedDeliveryTo) {
        ...
        List<AuctionDayAheadOfferEntity> capacityDAOffers = auctionDayAheadOfferRepository.findAllByTypeAndDeliveryDateFromAndTo(
        ...
        List<Long> offerIds = capacityDAOffers.stream().map(AuctionDayAheadOfferEntity::getId).collect(Collectors.toList());
        ...
        return provideExchangeDeviationData(capacityDAOffers, cmvcOffers, settlements);
    }
}
