package pl.com.tt.flex.server.security;
...
public class SecurityUtilsUnitTest {
    ...
    public void testIsCurrentUserInRole() {
        ...
        SecurityContextHolder.setContext(securityContext);
        assertThat(SecurityUtils.isCurrentUserInAuthority(Role.ROLE_ADMIN.name())).isTrue();
        assertThat(SecurityUtils.isCurrentUserInAuthority(Role.ROLE_MARKET_OPERATOR.name())).isFalse();
    }
