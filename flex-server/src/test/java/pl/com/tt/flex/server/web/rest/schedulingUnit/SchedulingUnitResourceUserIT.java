...
@WithMockUser(authorities = {FLEX_USER_SCHEDULING_UNIT_VIEW, FLEX_USER_SCHEDULING_UNIT_MANAGE, FLEX_USER_SCHEDULING_UNIT_DELETE})
public class SchedulingUnitResourceUserIT extends SchedulingUnitResourceIT {
    ...
    private final static String requestUri = "/api/user/scheduling-units";

    @Autowired
    public SchedulingUnitResourceUserIT(SchedulingUnitRepository schedulingUnitRepository, SchedulingUnitMapper schedulingUnitMapper,
    ...
    protected void mockedCurrentLoggedUser() {
        mockedCurrentLoggedUser(1L, "bsp-test", Set.of(ROLE_BALANCING_SERVICE_PROVIDER));
    }
