...
import pl.com.tt.flex.server.config.audit.AuditEventConverter;
...
import static pl.com.tt.flex.server.repository.audit.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
...
public class CustomAuditEventRepositoryIT {
    ...
    public void setup() {
        ...
        PersistentAuditEventEntity testUserEvent = new PersistentAuditEventEntity();
        ...
        PersistentAuditEventEntity testOldUserEvent = new PersistentAuditEventEntity();
        ...
        PersistentAuditEventEntity testOtherUserEvent = new PersistentAuditEventEntity();
    ...
    public void addAuditEvent() {
        ...
        List<PersistentAuditEventEntity> persistentAuditEvents = persistenceAuditEventRepository.findAll();
        assertThat(persistentAuditEvents).hasSize(1);
        PersistentAuditEventEntity persistentAuditEvent = persistentAuditEvents.get(0);
