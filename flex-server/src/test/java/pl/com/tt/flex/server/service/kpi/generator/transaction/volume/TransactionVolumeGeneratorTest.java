...
class TransactionVolumeGeneratorTest {
    private final TransactionVolumeDataFactory transactionVolumeDataFactory;
    private final TransactionVolumeGenerator transactionVolumeGenerator;

    TransactionVolumeGeneratorTest() {
        transactionVolumeDataFactory = Mockito.mock(TransactionVolumeDataFactory.class);
        transactionVolumeGenerator = new TransactionVolumeGenerator(transactionVolumeDataFactory);
    }
    ...
    void givenSimpleData_expectedGenerateFile() throws KpiGenerateException, IOException {
        ...
        Mockito.doReturn(transactionVolumeData).when(transactionVolumeDataFactory).createForCapacityOffers(Mockito.any(), Mockito.any());
        ...
        //when
        FileDTO generate = transactionVolumeGenerator.generate(kpiDTO);

        //then
        XSSFWorkbook expectedWorkbook = getExpectedWorkbook(new ClassPathResource("/templates/kpi/transaction/volumes/VolumeOfTransactions_03_10_2022-02_11_2022.xlsx"));
