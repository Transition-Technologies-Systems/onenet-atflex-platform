...
@NoArgsConstructor
@EqualsAndHashCode
public class ConsumeDataViewCriteria implements Serializable, Criteria {
	...
	public ConsumeDataViewCriteria(ConsumeDataViewCriteria other) {
	...
	public Criteria copy() {
		return new ConsumeDataViewCriteria(this);
	}
}
