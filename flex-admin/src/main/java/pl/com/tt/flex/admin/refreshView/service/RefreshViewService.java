...
public interface RefreshViewService {
  ...
  void postModifiedAlgorithmEvaluation(AlgorithmEvaluationViewDTO algorithmEvaluationDTO);

  void postAlgorithmEvaluationLogs(Long evaluationId, FileContentDTO fileContentDTO);

  void postAlgorithmEvaluationStatus(MinimalDTO<Long, AlgorithmStatus> evaluationStatus);
