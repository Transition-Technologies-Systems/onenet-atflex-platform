...
export class DayAheadService extends HttpService {
  protected url = 'flex-server/api/admin/auctions-day-ahead';
  protected seriesUrl = 'flex-server/api/admin/auctions-series';
  ...
  getOffers(parameters: any): Observable<any[]> {
    ...
    return this.get('flex-server/api/admin/auctions-day-ahead/offers', {
      params: {
        ...params,
  ...
  update(id: number, data: AuctionDayAheadDTO): Observable<void> {
