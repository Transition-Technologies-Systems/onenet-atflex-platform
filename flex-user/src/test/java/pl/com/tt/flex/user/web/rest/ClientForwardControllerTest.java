package pl.com.tt.flex.user.web.rest;
...
public class ClientForwardControllerTest {
    ...
    public void getWebsocketInfoEndpoint() throws Exception {
        restMockMvc.perform(get("/broadcast/info"))
            .andExpect(status().isNotFound());
    }

    @Test
    public void getWebsocketEndpoint() throws Exception {
        restMockMvc.perform(get("/broadcast/tracker/308/sessionId/websocket"))
            .andExpect(status().isNotFound());
    }

    @Test
    public void getWebsocketFallbackEndpoint() throws Exception {
        restMockMvc.perform(get("/broadcast/tracker/308/sessionId/xhr_streaming"))
            .andExpect(status().isNotFound());
    }
