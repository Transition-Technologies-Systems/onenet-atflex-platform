package pl.com.tt.flex.user.gateway.responserewriting;
...
import static pl.com.tt.flex.user.gateway.responserewriting.SwaggerBasePathRewritingFilter.gzipData;
