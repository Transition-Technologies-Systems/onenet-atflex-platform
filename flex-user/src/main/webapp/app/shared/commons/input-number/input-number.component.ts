...
export class InputNumberComponent implements ControlValueAccessor, OnInit, OnDestroy, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    this.inputNumber.updateInput = (value, insertedValueStr, operation, valueStr) => {
      ...
      let inputValue = this.inputNumber.input.nativeElement.value;
      ...
      if (currentLength === 0) {
        ...
        let selectionStart = this.inputNumber.input.nativeElement.selectionStart;
        ...
        if (operation === 'range-insert') {
          ...
          let isGroupChar = this.inputNumber._group.test(nextChar);
