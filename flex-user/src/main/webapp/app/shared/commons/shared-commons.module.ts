...
import { DictionaryNamePipe, FilterPipe, FormatVolumePipe, PrintDictionaryPipe } from './pipe';
...
import { ManualsDownloadComponent } from './manuals-download/manuals-download.component';
