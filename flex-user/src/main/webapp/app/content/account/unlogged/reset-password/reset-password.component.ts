...
export class ResetPasswordComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.isChangePassword = !!this.route.snapshot.data.isChangePassword;
  }
  ...
  resetPassword(): void {
    ...
    this.service
      .resetPassword(data)
      .pipe(
        catchError((): any => this.toastrService.error('account.resetPassword.error')),
  ...
  private createForm(): UntypedFormGroup {
    return this.fb.group({
      password: [null, [RequiredNoWhitespaceValidator, matchValues('confirmPassword', true)]],
