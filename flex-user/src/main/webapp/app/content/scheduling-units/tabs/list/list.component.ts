...
import { SchedulingUnitsListStore } from './list.store';
...
import { SchedulingUnitsPreviewComponent } from '../../preview';
...
@Component({
  selector: 'app-scheduling-unit-list',
  templateUrl: './list.component.html',
  providers: [ConfirmationService],
})
export class SchedulingUnitsListComponent extends TableExtends implements OnInit {
  ...
  constructor(
    ...
    private store: SchedulingUnitsListStore,
  ...
  getCollection(): void {
    const dateTimeKeys = ['createdDate', 'createdDate', 'lastModifiedDate', 'validFrom', 'validTo'];
    ...
    this.parameters = {
      ...
      filters: {
        ...
        'id.equals': this.schedulungUnitId,
      },
    };
