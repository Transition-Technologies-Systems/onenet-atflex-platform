...
import { DefaultParameters, FileDTO, LocalizationTypeDTO, Pageable } from '@app/shared/models';
...
export class SubportfoliosService extends HttpService {
  protected url = 'api/user/subportfolio';
  ...
  getLocalizationsDict(type: LocalizationType): Observable<LocalizationTypeDTO[]> {
